// Gère la persistance de l'état de lecture (sauvegarde automatique dans IndexedDB)
...
interface UsePlaybackPersistenceReturn {
    /** Restaure manuellement l'état depuis IndexedDB */
    restoreState: () => Promise<PlaybackState | null>;
    /** Déclenche une sauvegarde immédiate */
    saveNow: () => Promise<void>;
}

// Hook pour persister l'état de lecture
