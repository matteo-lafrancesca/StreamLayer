...
import { MediaBarDesktop } from '../MediaBarDesktop/index';
import { CompactMediaBar } from '../CompactMediaBar/index';
import { ExpandedPlayerHeader } from '../../Views/ExpandedPlayerHeader/index';
import { ProgressSlider } from '../../Common/ProgressSlider/index';

const ViewRenderer = React.lazy(() => import('../../Views/ViewRenderer').then(m => ({ default: m.ViewRenderer })));
import { usePlayerUI } from '@context/PlayerUIContext';
import { usePlayerExpansion } from '@hooks/UI/usePlayerExpansion';
import { useDraggablePlayer } from '@hooks/UI/useDraggablePlayer';
import { PLAYER_SIZES } from '@constants/playerSizes';
import sharedStyles from '@styles/PlayerShared.module.css';
import styles from './PlayerDesktop.module.css';
import {
    DndContext,
    useDraggable,
} from '@dnd-kit/core';
