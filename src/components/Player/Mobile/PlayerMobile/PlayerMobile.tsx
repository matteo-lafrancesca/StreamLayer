...
import { MediaBarMobile } from '../MediaBarMobile/index';
import { TrackViewMobile } from '../TrackViewMobile/index';
import { NavStack } from '../../Views/NavStack/index';
import { ExpandedPlayerHeaderMobile } from '../ExpandedPlayerHeaderMobile/index';
import { BottomSheet } from '../BottomSheet/index';

const PlaylistView = React.lazy(() => import('../../Views/PlaylistView').then(m => ({ default: m.PlaylistView })));
const ProjectView = React.lazy(() => import('../../Views/ProjectView').then(m => ({ default: m.ProjectView })));
const QueueView = React.lazy(() => import('../../Views/QueueView').then(m => ({ default: m.QueueView })));
import { ProgressSlider } from '../../Common/ProgressSlider';
import { usePlayerUI } from '@context/PlayerUIContext';
import { usePlayerExpansion } from '@hooks/UI/usePlayerExpansion';
